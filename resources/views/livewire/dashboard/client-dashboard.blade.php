<div class="space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            <flux:heading size="xl" level="1">{{ __('Client Support Dashboard') }}</flux:heading>
            <flux:subheading>{{ __('Track your IT support tickets, check progress, and review resolutions.') }}</flux:subheading>
        </div>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-zinc-400 dark:text-zinc-500">
                                <div class="flex flex-col items-center justify-center space-y-2">
                                    ...
                                    <span class="text-sm">{{ __('You have not submitted any support tickets.') }}</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
